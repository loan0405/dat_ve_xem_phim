      ...
      children: [
        Column(
          children: [
            ...
            buildGenreRow(size.height, 'Kinh dị', 'Hành động'),
            SizedBox(height: 20),
            buildGenreRow(size.height, 'Chính kịch', 'Chiến tranh'),
            SizedBox(height: 20),
            buildGenreRow(size.height, 'Hài kịch', 'Phá án'),
            SizedBox(height: 20),
            Container(
              padding: EdgeInsets.only(bottom: 10),
              alignment: Alignment.centerLeft,
            ...
            buildGenreRow(size.height, 'Việt Nam', 'Anh Quốc'),
            SizedBox(height: 20),
            buildGenreRow(size.height, 'Nhật Bản', 'Hàn Quốc'),
            SizedBox(height: 20),
